...
import com.chen.mm.web.AdminController;
...
privileged aspect AdminController_Roo_Controller {
    ...
    public String AdminController.show(@PathVariable("id") Integer id, Model uiModel) {
    ...
    public String AdminController.updateForm(@PathVariable("id") Integer id, Model uiModel) {
        populateEditForm(uiModel, Admin.findAdmin(id));
        return "admins/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
    public String AdminController.delete(@PathVariable("id") Integer id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
