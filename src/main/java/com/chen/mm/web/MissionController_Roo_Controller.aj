...
privileged aspect MissionController_Roo_Controller {
    ...
    public String MissionController.show(@PathVariable("id") Integer id, Model uiModel) {
    ...
    public String MissionController.updateForm(@PathVariable("id") Integer id, Model uiModel) {
        populateEditForm(uiModel, Mission.findMission(id));
        return "missions/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
    public String MissionController.delete(@PathVariable("id") Integer id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
    ...
    void MissionController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("mission_createtime_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }
